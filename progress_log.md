...
| Nov 2025 | To-Do List Manager | CLI To-Do app with dictionary-based data and menu-driven interface | Completed |
| Ongoing | Mini Utilities Collection | Upcoming small automation & Python utility scripts | In Progress |
...
| Nov 2025 | LeetCode Daily Practice | 10 problems completed, consistency improving | In Progress |
...
- Daily:
  ...
  - Make one Git commit minimum

- Weekly:
  - Refactor or enhance one mini-project
  - Push all changes and maintain documentation
...
## Notes
- Working on consistency and regular uploads to GitHub.
- Plan to update LeetCode folder daily with 2 problems until fully caught up with solved list.
- Next project idea: Basic File Organizer (Python CLI).

---

Maintaining this progress log as part of my coding journal to track learning and discipline.
